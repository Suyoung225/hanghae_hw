...
public class NaverShopSearch {
    public String search(String query) {
        ...
        headers.add(Key.headerName1, Key.headerValue1);
        headers.add(Key.headerName2, Key.headerValue2);
        String body = "";

        HttpEntity<String> requestEntity = new HttpEntity<String>(body, headers);
        ResponseEntity<String> responseEntity = rest.exchange("https://openapi.naver.com/v1/search/shop.json?query=" +query+"&sort=dsc", HttpMethod.GET, requestEntity, String.class);
